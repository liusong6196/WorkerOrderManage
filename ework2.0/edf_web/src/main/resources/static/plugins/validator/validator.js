    ...
    $(this).find("[isvalid=yes]").each(function () {
        ...
        if (checkexpession != undefined) {
            ...
            switch (checkexpession) {
                ...
                case "NotNullSelect":
                {
                    if (isNotNullSelect(value)) {
                        Validatemsg = errormsg + "请选择！\n";
                        Validateflag = false;
                        ValidationMessage($(this), Validatemsg); return false;
                    }
                    break;
                ...
                case "SELECTNotNULL":
                    {
                        if (!isSELECTNotNULL(value,$(this).attr("msg"))) {
                            Validatemsg = errormsg + ""+$(this).attr("msg")+"\n";
                            Validateflag = false;
                            ValidationMessage($(this), Validatemsg); return false;
                        }
                        break;
