...
public class Configurations {
	static final String CONFIG_FILE = "config/stream-config.properties";
	...
	public static String getFileRepository() {
		String pathTemp = new File("").getAbsolutePath();
		String val = pathTemp + getConfig("STREAM_FILE_REPOSITORY");
