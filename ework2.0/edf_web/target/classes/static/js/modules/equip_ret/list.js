...
function getGrid() {
	$('#dataGrid').bootstrapTableEx({
		...
		columns: [
			...
			{field : "borCount", title : "数量", width : "60px",align : "center"},
			{field : "borSiteName", title : "使用地点", width : "60px",align : "center"},
			{field : "borPlantime", title : "计划归还日期", width : "100px",align : "center"},
			{field : "retDateTime", title : "实际归还日期", width : "100px",align : "center"},
			{field : "proNumber", title : "项目编号", width : "150px",align : "center"},
			{field : "proName", title : " 项 目 名 称 ", width : "300px",align : "left"},
			{field : "remark", title : "备  注", width : "200px",align : "left"},
			{
...
var vm = new Vue({
	...
	methods : {
		...
		save: function() {
			dialogOpen({
				title: '设备申请',
				url: 'sys/equip_ret/add.html?_' + $.now(),
				width: '600px',
				height: '90%',
		...
		edit: function() {
			...
			if(checkedRow(ck)){
				dialogOpen({
					title: '归还',
					url: 'sys/equip_ret/edit.html?_' + $.now(),
					width: '500px',
					height: '90%',
					scroll:true,
