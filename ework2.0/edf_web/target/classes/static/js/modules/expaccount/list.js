...
function getGrid() {
	$('#dataGrid').bootstrapTableEx({
		...
		columns: [
			...
			{field : "proName", title : "关联项目", width : "250px",
				/*formatter : function(value, row, index) {
					$.ajax({
						type: "post",
			...
			{field : "travelSite", title : "出差地", width : "15px",align:"center"}, 
...
//			dialogOpen({
//				title: '新增报销明细表',
//				url: 'sys/expaccount/add.html?_' + $.now(),
//				width: '90%',
//				height:'80%',
...
//			});
		...
		edit: function() {
			...
			if(checkedRow(ck)){
				var b =true;
				if(ck[0].expAccState==2||ck[0].expAccState==4){
					b=false;
				}
				if(b){
				    //document.cookie ="expAccId=" + ck[0].expAccId;
				    localStorage.expAccId = ck[0].expAccId;
					window.location.href='edit.html';
//					dialogOpen({
//						title: '编辑报销明细表',
//						url: 'sys/expaccount/edit.html?_' + $.now(),
//						width: '90%',
//						height:'80%',
...
//				dialogOpen({
//					title: '查看报销明细',
//					url: 'sys/expaccount/find.html?_' + $.now(),
//					width: '70%',
//					height:'85%',
//					btn:['打印','取消'],
//					success: function(iframeId){
...
//				});
			...
			if(checkedRow(ck)){
				dialogOpen({
					title: '打印报销单',
					url: 'sys/expaccount/print.html?_' + $.now(),
					width: '90%',
					height:'85%',
					btn:['打印','取消'],
					success: function(iframeId){
